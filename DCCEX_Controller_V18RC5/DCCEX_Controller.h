...
************************************************************************/
  ...
  #define Version "V1.8RC5"
  uint8_t EEPROMCODE = 185;
...
//    #define numAccs 96                              //Number of accessories supported
  ...
  //**************************************************************************************
  #elif defined (PICO) || defined (PICO_W) || defined (PICO_2W)
    #define Console Serial
...
//    #define numRoutes 48
 ...
 // loco hcLoco[numLocos];
  ...
  //THE OPTIONS BELOW SHOULD BE CHANGED VIA THE CONTROLLER CONFIG PAGE ONLY
...
const uint16_t configBase    = routeStateBase + (numRoutes*routeLen/2);           //Refer below for Config Size
...
//  const uint16_t DARK_GREY = 25388;
  ...
  */
  ...
  uint8_t credIndex = 0;                              //Credential selected Index
  uint8_t accStates[numAccs];
  uint8_t selectedAccs[numAccs];  //for Routes...
  uint16_t selectedIDs[tCount][numLocoSlots] = {255};
