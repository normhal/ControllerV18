...
uint16_t selectedIDs[tCount][numLocoSlots] = {{0, 3, 2, 1, 4, 5, 6, 7, 8, 9},
...
HCLoco hcLoco[NUM_HCLOCOS] =
{
  {"Santa Fe", "SW-12", 2280, 2280, "0"
  {"Great N.", "SW-12", 25, 25, "1",
  {"Burl. N.", "SD40-2", 6784, 6784,
  {"West Pac", "U28B", 754, 754, "3",
  {"CSX", "SW-12", 1125, 1125, "4",
};
